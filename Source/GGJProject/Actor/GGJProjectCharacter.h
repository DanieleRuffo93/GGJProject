...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnBubblePowSignature);
...
class AGGJProjectCharacter : public ACharacter
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Input, meta = (AllowPrivateAccess = "true"))
	UInputAction* CooldownTestAction;
...
protected:
	...
	void CooldownTest(const FInputActionValue& Value);
...
public:
	...
	FOnBubblePowSignature OnBubblePowDelegate;
